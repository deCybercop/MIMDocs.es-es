...
Si no ha configurado el paquete de instalación de MIM en el último paso, siga estas indicaciones para instalar los componentes de Microsoft Identity Manager 2016:
...
3.  Lea el contrato de licencia para el usuario final y, si acepta los términos de licencia, haga clic en **Siguiente**.
...
6.  En la página **Configure the MIM database connection** (Configurar la conexión de la base de datos de MIM), especifique **Create a new database** (Crear una base de datos nueva).

    ![Imagen de configuración de la conexión de base de datos de MIM](media/MIM-Install10.png)

7.  En **Configure mail server connection** (Configurar conexión del servidor de correo), indique el nombre de su servidor Exchange como **Servidor de correo**. Si no tiene configurado ningún servidor de correo, especifique localhost como el nombre del servidor y desactive las dos casillas superiores. Haga clic en **Siguiente**.
...
![Imagen de instalación del servicio y el portal de MIM](media/MIM-Install16.png)
