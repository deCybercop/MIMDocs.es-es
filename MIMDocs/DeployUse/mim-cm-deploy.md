...
1. Información general acerca de la implementación
...
- Vaya a la ubicación de los medios MIM y luego a la carpeta \\Certificate Management\\x64.

- Copie la carpeta Schema en CORPDC y, después, vaya hasta ella.

    ![](media/mim-cm-deploy/image005.png)

- Ejecute el escenario de bosque único del script resourceForestModifySchema.vbs

- Para el escenario de bosque de recursos ejecute los scripts:
...
Una vez que se ejecute el script debería recibir un mensaje de operación correcta.
...
En la tabla siguiente se resumen las cuentas y los permisos necesarios para MIM CM.
Puede permitir que MIM CM cree automáticamente las cuentas siguientes, o bien puede crearlas antes de la instalación. Los nombres reales de las cuentas se pueden cambiar. Si crea las cuentas usted mismo, considere la posibilidad de asignar nombres a las cuentas de usuario de manera que sea fácil hacer coincidir el nombre de la cuenta de usuario con su función.
...
En la pestaña **Nombre del sujeto**, desactive las casillas **Incluir el nombre de correo electrónico en el nombre del sujeto** y **Nombre de correo electrónico**.

En la pestaña **Extensiones**, en la lista **Extensiones incluidas en esta plantilla**, asegúrese de que la opción **Directivas de aplicación** está seleccionada y, después, haga clic en **Editar**.

En el cuadro de diálogo **Editar extensión de directivas de aplicación**, seleccione las directivas de aplicación **Sistema de cifrado de archivos** y **Correo seguro**. Haga clic en **Quitar**y, a continuación, haga clic en **Aceptar**.

En la pestaña **Seguridad**, siga estos pasos:
...
En el cuadro de diálogo **Propiedades de plantilla nueva**, haga clic en **Aceptar**.

Deje abierta la **Consola de plantillas de certificado**.
...
-   En la **consola Plantillas de certificado**, en el panel de **detalles**, seleccione y haga clic con el botón derecho en **Agente de inscripción** y después haga clic en **Plantilla duplicada**.

En el cuadro de diálogo **Plantilla duplicada**, seleccione **Windows Server 2003 Enterprise** y, después, haga clic en **Aceptar**.

En el cuadro de diálogo **Propiedades de plantilla nueva**, en el cuadro **Nombre para mostrar de plantilla** de la pestaña **General**, escriba **Agente de inscripción de MIM CM**. Asegúrese de que el **Período de validez** es **2 años**.

En la pestaña **Tratamiento de la solicitud**, active la casilla **Permitir que la clave privada se pueda exportar** y, después, haga clic en la **pestaña CSP o criptografía**.

En el cuadro de diálogo **Selección de CSP**, deshabilite **Microsoft Base Cryptographic Provider v1.0**, deshabilite **Proveedor de cifrado mejorado de Microsoft v1.0**, habilite **Proveedor de servicios de cifrado RSA y AES mejorado de Microsoft**, y después haga clic en **Aceptar**.
...
1. Inicie sesión en **CORLog en con la cuenta **MIMINSTALL**.
...
16. En el cuadro de diálogo de advertencia **Asistente de configuración: Microsoft Forefront Identity Manager 2010 R2**, haga clic en **Aceptar** para confirmar que no se ha habilitado SSL en el directorio virtual de IIS.
    ...
    >[!NOTE] 
    No haga clic en el botón Finalizar hasta que termine la ejecución del asistente de configuración. El registro del asistente se puede encontrar aquí:**%archivos_de_programa%\\Microsoft Forefront Identity Management\\2010\\Certificate Management\\config.log**
...
7. Haga clic con el botón derecho en **CORPCA-contoso-CA***,* seleccione **Todas las tareas** y, después, haga clic en **Detener servicio**. Espere hasta que Servicios de certificados de Active Directory se detenga.

8. Haga clic con el botón derecho en **contoso-CORPCA-CA***,* seleccione **Todas las tareas** y, después, haga clic en **Iniciar servicio**.
...
12. En la lista de eventos, compruebe que los eventos más recientes *no* incluyen ningún evento **Advertencia** o **Error** desde el último reinicio de Servicios de certificados.
    ...
    >[!NOTE] 
    El último evento debería indicar que el módulo de salida se cargó con la configuración de ```SYSTEM\CurrentControlSet\Services\CertSvc\Configuration\ContosoRootCA\ExitModules\Clm.Exit```.
...
- En el cuadro de diálogo **Propiedades de configuración**, asegúrese de que la huella digital aparece en la lista **Certificados de firma válidos** y, después, haga clic en **Aceptar**.

- En el cuadro de mensaje **FIM Certificate Management**, haga clic en **Aceptar**.

- En el cuadro de diálogo **Propiedades de contoso-CORPCA-CA**, haga clic en **Aceptar**.

- Haga clic con el botón derecho en **contoso-CORPCA-CA***,* seleccione **Todas las tareas** y, después, haga clic en **Detener servicio**.

- Espere hasta que Servicios de certificados de Active Directory se detenga.

- Haga clic con el botón derecho en **contoso-CORPCA-CA***,* seleccione **Todas las tareas** y, después, haga clic en **Iniciar servicio**.

- Cierre la consola **Entidad de certificación**.

- Cierre todas las ventanas abiertas y después cierre la sesión.
...
- Primeros pasos: **configuración de permisos de punto de conexión de servicio y grupo de destino, y delegación de la administración de plantillas de perfil**
  - Configurar permisos en el punto de conexión de servicio (SCP).

  - Configurar la administración de plantillas de perfil delegadas.

  - Configurar permisos en el punto de conexión de servicio (SCP). **\<sin script\>**

        -   Asegúrese de que está conectado al servidor virtual **CORPDC**.

        -   Inicie sesión como **contoso\\corpadmin**.

        -   Desde **Herramientas administrativas**, abra **Usuarios y equipos de Active Directory**.

        -   En **Usuarios y equipos de Active Directory**, en el menú **Ver**, asegúrese de que la opción **Características avanzadas** está seleccionada.

        -   En el árbol de consola, expanda **Contoso.com** \| **System** \| **Microsoft** \| **Certificate Lifecycle Manager** y, después, haga clic en **CORPCM**.

        -   Haga clic con el botón derecho en **CORPCM** y, después, haga clic en **Propiedades**.

        -   En el cuadro de diálogo **Propiedades de CORPCM**, en la pestaña **Seguridad**, agregue los grupos siguientes con los permisos correspondientes:
...
- En el cuadro de diálogo **Propiedades de CORPDC**, haga clic en **Aceptar**.

- Mantenga abierto **Usuarios y equipos de Active Directory**.

- **Configurar permisos en los objetos de usuario descendiente**
    - Asegúrese de que sigue en la consola de **Usuarios y equipos de Active Directory**.
    - En el árbol de consola, haga clic con el botón derecho en **Contoso.com** y, después, haga clic en **Propiedades**.
    - En la pestaña **Seguridad**, haga clic en **Opciones avanzadas**.
    - En el cuadro de diálogo **Configuración de seguridad avanzada para Contoso**, haga clic en **Agregar**.
    - En el cuadro de diálogo **Seleccionar usuario, equipo, cuenta de servicio o grupo**, escriba **mimcm-Managers** en el cuadro de texto **Escriba el nombre del objeto para seleccionar** y después haga clic en **Aceptar**.
    - En el cuadro de diálogo **Entrada de permiso para Contoso**, en la lista **Se aplica a**, seleccione **Objetos de usuario descendiente** y, después, active la casilla **Permitir** de los **permisos** siguientes:
    ...
    - En el cuadro de diálogo **Entrada de permiso para Contoso**, haga clic en **Aceptar**.
    - En el cuadro de diálogo **Configuración de seguridad avanzada para Contoso**, haga clic en **Agregar**.
    - En el cuadro de diálogo **Seleccionar usuario, equipo, cuenta de servicio o grupo**, escriba **mimcm-HelpDesk** en el cuadro de texto **Escriba el nombre del objeto para seleccionar** y después haga clic en **Aceptar**.
    - En el cuadro de diálogo **Entrada de permiso para Contoso**, en la lista **Se aplica a**, seleccione **Objetos de usuario descendiente** y, después, active la casilla **Permitir** de los **permisos** siguientes: - **Leer todas las propiedades** - **Permisos de lectura** - **FIM CM Enrollment Agent** - **FIM CM Request Revoke** - **FIM CM Request Unblock Smart Card**.
    - En el cuadro de diálogo **Entrada de permiso para Contoso**, haga clic en **Aceptar**.
    - En el cuadro de diálogo **Configuración de seguridad avanzada para Contoso**, haga clic en **Aceptar**.
    - En el cuadro de diálogo **Propiedades de contoso.com**, haga clic en **Aceptar**.
    - Mantenga abierto **Usuarios y equipos de Active Directory**.
...
- Definir permisos en el contenedor Plantillas de certificado
     ...
     6. En el cuadro de diálogo **Seleccionar usuarios, equipos o grupos**, en el cuadro **Escriba los nombres de objeto para seleccionar**, escriba **mimcm-Managers** y después haga clic en **Aceptar**.
     ...
     9.  En la página **Tipo de objeto de Active Directory**, asegúrese de que la opción **Esta carpeta, los objetos contenidos en la misma y la creación de nuevos objetos en esta carpeta** está seleccionada y, después, haga clic en **Siguiente**.
