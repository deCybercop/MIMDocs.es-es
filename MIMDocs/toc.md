...
## [Idiomas admitidos](microsoft-identity-manager-2016-language-support.md)
...
## [Concesión de licencias y descarga](microsoft-identity-manager-licensing.md)
...
### [Configuración del servidor: Exchange](prepare-server-exchange.md)
### [Instalación de MIM: Sincronización](install-mim-sync.md)
### [Instalación de MIM: Servicio y portal](install-mim-service-portal.md)
### [Instalación de MIM: Sincronización de bases de datos](install-mim-sync-ad-service.md)
...
## [Software de Microsoft Identity: Versiones de compilación de lanzamiento público](https://blogs.technet.microsoft.com/iamsupport/idmbuildversions/)
