...
---
# <a name="work-with-hybrid-reporting-in-identity-manager-public-preview-refresh"></a>Trabajo con informes híbridos en la versión preliminar pública de Identity Manager (actualización)
...
* Identity Manager 2016 RTM o el servicio SP1 Identity Manager.
