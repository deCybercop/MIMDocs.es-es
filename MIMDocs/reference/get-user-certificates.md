---
title: Obtener certificados de usuario | Microsoft Docs
description: 
keywords: 
author: msmbaldwin
ms.author: mbaldwin
...
---
# <a name="get-user-certificates"></a>Get User Certificates
...
Si se ejecuta correctamente, devuelve una lista de objetos JSON serializados [Microsoft.Clm.Shared.Certificates.X509ClmCertificate](https://msdn.microsoft.com/library/microsoft.clm.shared.certificates.x509clmcertificate(v=vs.100).aspx) con las siguientes propiedades:
...
SolicituderNombre | La cuenta que solicitó el certificado.
SerialNumber | Numero de serie del certificado.
Estado | Estado del certificado.
TemplateCommonNombre | Nombre común de la plantilla de certificado del certificado.
